...
-- Cost Intelligence Agency - Database Schema v3.0
-- 
-- Changes from v2:
-- - Split facility names into separate table (facility_names) for privacy/encryption
-- - Added facility relationship support (parent_facility_id, billing_entity_id)
-- - Added vendor facility types (dme_supplier, pharmacy, medical_supply)
-- - Added totals_validated flag to bills table
--
-- Tables: facilities, facility_names, users, bills, line_items, procedure_categories
